...
# Fix: Automatically paginate data frames
knitr::opts_knit$set(rmarkdown.df_print = "reactable")
options(reactable.defaultPageSize = 10)
...
```{r}
# Print nigerm96
rmarkdown::paged_table(nigerm96)
```
...
# Print nigerm04
rmarkdown::paged_table(nigerm04)
```
...
![{ggplot2} has a variety of different geom\_\* functions and geometric objects which you can use to visualize your data. Here are some examples of different types of geoms that can be used with ggplot().](images/geoms.png)
...
![Common aesthetic attributes used in ggplot graphics.](images/common_aesthetics_1.png){width="507"}
